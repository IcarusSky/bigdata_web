...
@ProviderName(name = "PostgreSQL", parent = "自建数据源", order = 1)
public class PostgreSQLDataProvider extends JdbcDataProvider {

    private String JDBC_URL = "jdbc:postgresql://IP:PORT/DATABASES?useUnicode=true&characterEncoding=utf8&connectTimeout=" + DATASOURCE_CONNECT_TIMEOUT_MILLIS;
